...
void menu_karbari()
{
    while (true)
    {
        ...
        if(number==1)
        {
            ...
            if(strcmp(cJSON_GetObjectItem(buffer,"type"),"Error")==0)
            {
                SetColor(12);
                printf("\n%s\n\n",cJSON_GetObjectItem(buffer,"content"));
            }
            else
            {
                clear();
        ...
        if(number ==2)
        {
            ...
            if(strcmp(cJSON_GetObjectItem(buffer,"type"),"Error")!=0)
            {
                strcpy(authtoken,cJSON_GetObjectItem(buffer,"content"));
                clear();
...
void menu_goftogoo(const char * chaname)
{
    while(true)
    {
        ...
        if(number==2)
        {
            ...
            {
                char allarray[MAX];
                strcpy(allarray,cJSON_GetObjectItem(buffer, "content"));
                ...
                {
                    char a[MAX],sender[MAX],content[MAX];
                    strcpy(a,cJSON_GetArrayItem(allarray,i));
                    strcpy(sender,cJSON_GetObjectItem(a,"sender"));
                    strcpy(content,cJSON_GetObjectItem(a,"content"));
        ...
        if(number==4)
        {
            ...
            if(strcmp(cJSON_GetObjectItem(buffer,"type"),"Error")!=0)
            {
                ...
                for(int i=0; i<arraylen; i++)
                {
                    printf("member %d: %s\n",i+1,cJSON_GetArrayItem(allarray,i));
                }
                pointer_place=1;
            }
        ...
        if(number==5)
        {
            ...
            if(strcmp(cJSON_GetObjectItem(buffer,"type"),"Error")!=0)
            {
                ...
                SetColor(9);
                char isthere[10];
                strcpy(isthere,cJSON_GetObjectItem(buffer, "content"));
